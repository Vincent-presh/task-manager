        ...
        <div className="glass rounded-3xl p-8 shadow-2xl border border-white/20">
          ...
          >
            ...
            <p className="text-white/70 text-sm">
              {isSignUp ? 'Create your account to get started' : 'Sign in to continue to your tasks'}
            </p>
          </motion.div>
          ...
          >
            ...
            {showEmailMessage && (
              <motion.div
                initial={{ opacity: 0, y: -10 }}
                animate={{ opacity: 1, y: 0 }}
                className="bg-green-500/20 border border-green-500/30 text-green-200 px-4 py-3 rounded-xl text-sm backdrop-blur-sm"
              >
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-green-300/80 mt-1">
                      We've sent you a sign-in link. Click it to complete your registration.
                    </p>
                  </div>
                </div>
              </motion.div>
