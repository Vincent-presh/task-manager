...
const taskTitle: (title: string) => ValidationResult = (title) => {
...
const taskDescription: (description: string) => ValidationResult = (
  description
) => {
...
const comment: (content: string) => ValidationResult = (content) => {
...
const file: (file: File) => ValidationResult = (file) => {
...
const tag: (tag: string) => ValidationResult = (tagStr) => {
  const sanitized = sanitizeInput.text(tagStr);
